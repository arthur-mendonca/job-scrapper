...
import { dashboardResponseSchema } from '../api-schemas.js';
  ...
  typedApp.get(
    '/dashboard',
    {
      schema: {
        ...
        description: 'Returns aggregated metrics for the dashboard including job counts, source stats, and recent collection runs.',
        response: {
